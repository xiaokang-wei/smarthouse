package com.ruoyi.project.product.show.domain;
...
public class ProShow {
    ...
    public ProShow(Integer pdId, String pdType, String pdName, String pdImg, String pdSeries, String pdStyle, String pdPecs, String pdMaterials, String pdPlace, String pdPrice, String pdNum, String pdTotal) {
        this.pdId = pdId;
        this.pdType = pdType;
        this.pdName = pdName;
        this.pdImg = pdImg;
    ...
    public String toString() {
        return "ProShow{pdId = " + pdId + ", pdType = " + pdType + ", pdName = " + pdName + ", pdImg = " + pdImg + ", pdSeries = " + pdSeries + ", pdStyle = " + pdStyle + ", pdPecs = " + pdPecs + ", pdMaterials = " + pdMaterials + ", pdPlace = " + pdPlace + ", pdPrice = " + pdPrice + ", pdNum = " + pdNum + ", pdTotal = " + pdTotal + "}";
    }
}
