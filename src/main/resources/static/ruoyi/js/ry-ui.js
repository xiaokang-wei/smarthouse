    ...
    $.extend({
        ...
        operate: {
            ...
            selectList: function (id) {
                table.set();
                $.modal.open("查看" + table.options.modalName, $.operate.selectListUrl(id));
            },
            // 添加信息，以tab页展现
            addTab: function (id) {
                table.set();
            ...
            selectListUrl: function (id) {
                var url = $.common.isEmpty(id) ? table.options.listUrl.replace("{id}", id) : table.options.listUrl.replace("{id}", id);
                return url;
            },
            // 修改信息
            edit: function (id) {
